...
import com.example.FlixTix.Entities.*;
import com.example.FlixTix.EntryDtos.DeleteTicketEntryDto;
import com.example.FlixTix.EntryDtos.TicketEntryDto;
import com.example.FlixTix.Repository.ShowRepository;
import com.example.FlixTix.Repository.TicketRepository;
...
public class TicketService {
    ...
    public ResponseEntity addTicket(TicketEntryDto ticketEntryDto) throws Exception{
        ...
        System.out.println("uuuuuuuuuuuuuuuuuu"+user.getUserName());
        ...
        mimeMessageHelper.setFrom("akshatanale.06@gmail.com");
